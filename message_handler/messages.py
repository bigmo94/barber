...
SUCCESS_PROFILE_WAS_UPDATED = 2006
SUCCESS_SERVICE_WAS_CREATED = 2007
...
SUCCESS_MESSAGE_CODES = {
    ...
    SUCCESS_PROFILE_WAS_UPDATED: _('Your profile was updated.'),
    SUCCESS_SERVICE_WAS_CREATED: _('The service was created.'),
}
